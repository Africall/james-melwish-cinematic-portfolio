      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <p>
                <span className="text-[#F3DBB3] font-medium">James Melwish</span> does both, and that is the whole point.
                At Spans Ventures Limited in Nairobi he runs business development for SpansCall, drives product
                management across the Spans product line, and is also the engineer on the platform behind it. The
              ...
              <p>
                ...
                internet drops, the power flickers, and the customer pays by mobile money. He speaks Swahili, English,
                French and Korean. Home is Nairobi: a wife, a son, and one more reason the systems have to keep
                working.
              </p>
            </motion.div>

            {/* Proof Strip: 4-Item Metrics Grid */}
            <motion.div
              variants={fadeUpVariants}
          ...
          {/* ================= RIGHT MONOGRAM FRAME (PERFECT LOCKED GEOMETRY) ================= */}
          <div className="lg:col-span-5 flex items-center justify-center relative perspective-[1400px]">
            ...
            >
              ...
              {/* Living Portrait Canvas */}
              <div className="relative overflow-hidden w-[390px] max-w-[80vw] aspect-[4/5] bg-black rounded-sm">
                <img
                  src="images/james-portrait.jpg"
                  alt="James Melwish"
                  className="absolute inset-0 w-full h-full object-cover object-top filter brightness-[0.96] contrast-[1.05] saturate-[1.02] group-hover:brightness-105 group-hover:contrast-[1.1] transition-all duration-700 ease-out"
                />

                {/* Caption Strip */}
                <div className="absolute bottom-4 left-4 z-20 select-none">
                  <span
                    className="block text-[9px] font-medium tracking-[0.3em] uppercase text-[#C4B29E]"
                    style={{ fontFamily: "'Montserrat', sans-serif" }}
                  >
                    FROM THE FIRST COLD CALL
                    <br />
